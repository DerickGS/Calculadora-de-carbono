...
import amazonia from "../img/amazonia.jpg"
        ...
        <body>
            ...
            <main className={styles._pageHome}>
                ...
                <div className={styles._content}>
                    ...
                    <div className={styles.texto_e_imagem}>
                        ...
                        <figure>
                            <img className={styles._imgHome} src={carbonDioxide} alt="Chaminés de fábricas com grande quantidade de fumaça sendo gerada" />
                    ...
                    <div className={styles.texto_e_imagem}>
                        ...
                        <figure>
                            <img className={styles._imgHome} src={heatWave} alt="Senhor idoso com fadiga devido ao calor extremo em um centro urbano" />
                    ...
                    <div className={styles.texto_e_imagem}>
                        ...
                        <figure>
                            <img className={styles._imgHome} src={bigAcceleration} alt="Mineração de carvão com uma extensa equipe de trabalhadores e uma variedade de maquinários de grande porte" />
                    ...
                    <div className={styles.texto_e_imagem}>
                        ...
                        <figure>
                            <img className={styles._imgHome} src={carbonImg} alt="Vista de uma usina de lixo com grandes estruturas de metal e concreto, incluindo uma área de recebimento de resíduos onde o lixo é descarregado" />
                    ...
                    <div className={styles.texto_e_imagem}>
                        <p>A crescente relevân <a href="https://www.gov.br/mma/pt-br/composicao/smc/dcol/cim">Comitê Interministerial sobre Mudança do Clima (CIM)</a> , a criação de um Plano Clima que orientará as ações de mitigação e adaptação até 2035, e o fortalecimento da participação social. Além disso, a redução do desmatamento na Amazônia e o uso de recursos do Fundo Clima são essenciais para o Brasil atingir suas metas climáticas.</p>
                        <figure>
                            <img className={styles._imgHome} src={amazonia} alt="Área de desmatamento extenso na floresta amazônica. O cenário mostra um vasto espaço de terreno limpo, sem vegetação original, com algumas árvores isoladas ao fundo e fumaça no ar, indicando queimadas." />
                            <figcaption>Foto: Marizilda Cruppe / Greenpeace / Amazônia</figcaption>
                        </figure>
                    </div>
                    <p>Essas ações visam fortalecer a posição do Brasil no cenário internacional, especialmente com a realização da COP30 em Belém, Pará, em 2025, onde o país poderá assumir um papel de liderança no esforço global contra as mudanças climáticas.</p>
