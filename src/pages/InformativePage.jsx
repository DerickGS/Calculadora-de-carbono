        ...
        <main className={styles._pageInformative}>
          ...
          <div className={styles._contentTest}>
            ...
            <div className={styles.texto_e_imagem}>
              ...
              <figure>
                  <img className={styles._imgInfo} src={CopRioDeJaneiro} alt="Evento histórico: Conferência da ONU sobre Meio Ambiente e Desenvolvimento, Rio de Janeiro, 1992" />
            ...
            <div className={styles.texto_e_imagem}>
              ...
              <figure>
                  <img className={styles._imgInfo} src={ConferenceDubai} alt="A 28ª Conferência das Partes (COP 28) realizada em Dubai, Emirados Árabes Unidos, no ano de 2023" />
